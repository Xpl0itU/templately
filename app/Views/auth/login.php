    ...
    <form action="<?= url_to('login') ?>" method="post" class="space-y-6">
        ...
        <div class="text-center space-y-2">
            <?php if (setting('Auth.allowMagicLinkLogins')) : ?>
                <p class="text-sm">
                    <a href="<?= url_to('magic-link') ?>" class="text-indigo-600 hover:text-indigo-500 transition duration-200">
            ...
            <?php if (setting('Auth.allowRegistration')) : ?>
                <p class="text-sm">
                    ...
                    <a href="<?= url_to('register') ?>" class="text-indigo-600 hover:text-indigo-500 font-medium transition duration-200">
                        Create one now
                    </a>
                </p>
            <?php endif ?>
