...
<div class="w-full max-w-md mx-auto">
    <div class="rounded-2xl shadow-2xl p-8 bg-white/20 backdrop-blur-lg border border-white/20">
        ...
        <form action="<?php echo url_to('login') ?>" method="post" class="space-y-5">
            <?php echo csrf_field() ?>
            ...
            <div class="pt-2">
                <button type="submit" 
                        class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-200 transform hover:scale-[1.02] shadow-md">
                    <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                        <i class="fas fa-sign-in-alt h-5 w-5 text-indigo-300 group-hover:text-indigo-200"></i>
                    </span>
                    Sign In
                </button>
            </div>
